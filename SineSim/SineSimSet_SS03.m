...
% Configuration: Linux host with one remote server using dual key
% authentication
...
% Choosing dual key will still use passwords if they are present, but dual
% key if password is empty string
