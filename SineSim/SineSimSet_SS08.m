...
% Configuration: Linux host with heterogeneous Virtual Machine that
% includes Stampede supercomputer; focus on use of notifications.
...
% located in the Custom Directory. Note that SIMDEF lines must have the
% additional "N" to make "SIMDEFN" for the simulation to be notified
% specifically.
