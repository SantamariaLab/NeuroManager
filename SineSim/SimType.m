...
% This file in the SineSim directory shows that a SimType.m file in the
% custom files directory will override the SimType.m file in the Core
% directory, giving a way for a person to have their own simtype list.
classdef SimType
    properties
        constrFunc;
    end
