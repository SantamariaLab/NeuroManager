...
% Configuration: Focus on automatic generation of SimSet via MATLAB script.
% We create a 10-simulation SimSpec that creates sinewaves with random
...
% A copy will be printed to file anyway for provenance.
    ...
    for j = 1:numSimSets
        ...
        ss.addTokenSet('SIMSETDEF', ['SineSimSpec09-' num2str(j)], ...
