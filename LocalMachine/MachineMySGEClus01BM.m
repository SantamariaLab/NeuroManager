...
% MachineMySGEClus01BM
classdef MachineMySGEClus01BM < MachineMySGECluster01
    methods
        function obj = MachineMySGEClus01BM(~,...
        ...
        qd = mySGECluster01QueueData.BIGMEM;
        parEnvStr = 'mt 8';             
        resourceStr = 'bigmem';     % mySGEClus01 specific for bigmem.q
