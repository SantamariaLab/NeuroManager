...
function md = createMySGECluster01Data()
    md = RMD();
    md.addSetting('id',                  'mySGECluster01');

    md.addSetting('fsUserName',          'usernamefs');
    md.addSetting('fsPassword',          '');
    md.addSetting('fsIPAddress',         '00.00.00.00');
    md.addSetting('jsUserName',          'usernamejs');
    md.addSetting('jsPassword',          ''); 
    md.addSetting('jsIPAddress',         '00.00.00.00');

    % All paths in UNIX format with beginning / and no trailing /.
    md.addSetting('matlabCompilerDir',   '/share/apps/MATLAB/R2013a/bin');
    md.addSetting('matlabCompiler',      'mcc');
    md.addSetting('matlabExecutable',    'matlab');
    md.addSetting('xCompDir',            '/home/username/SMComp'); % <-------
    md.addSetting('mcrDir',              '/share/apps/MATLAB/MATLAB_Compiler_Runtime/v81');

    md.addSetting('neuronDir',           '/share/apps/neuron/7.3');
