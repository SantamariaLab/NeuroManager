...
% MachineMySGEClus01Queue01
classdef MachineMySGEClus01Queue01 < MachineMySGECluster01
    methods
        function obj = MachineMySGEClus01Queue01(~,...
        ...
        qd = mySGECluster01QueueData.Queue01;
        parEnvStr = ''; %'mt 8';             % TEMP FOR NOW; FOR USE WITH MPI
        resourceStr = 'queue01_only';    % mySGEClus01 specific for queue01.q
        obj = obj@MachineMySGECluster01(qd,...
