...
% MachineStampedeNORMAL
% Specifies the normal queue on Stampede.
classdef MachineStampedeNORMAL < MachineStampede
    methods
        function obj = MachineStampedeNORMAL(wallClockTime,...
                            hostID, hostOS, baseDir,...
                            scratchDir, simFileSourceDir,...
                            custFileSourceDir, modelFileSourceDir,...
                            simType, numSims,...
                            auth, log, notificationSet) 
            qd = StampedeQueueData.NORMAL;
