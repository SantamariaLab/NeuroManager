...
% XCompileMySGECluster01
% A class which supports MATLAB cross-compilation on mySGECluster01.
classdef XCompileMySGECluster01 < XCompileMachine
    methods
        function obj = XCompileMySGECluster01(hostID, hostOS, idExt, auth)
            md = createMySGECluster01Data();
            obj = obj@XCompileMachine(md, hostID, hostOS, idExt, auth);
        end
    end
end