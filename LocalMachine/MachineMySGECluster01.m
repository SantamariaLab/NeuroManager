...
% MachineMySGECluster01
% Our local SGE Cluster has no constraints on wallclocktime and doesn't require
% cross-compilation (for us, anyway). It also has Neuron installed.
classdef MachineMySGECluster01 < MachineSGECluster & NeuronMachine
    methods
        function obj = MachineMySGECluster01(qd,...
            ...
            md = createMySGECluster01Data();
            obj = obj@NeuronMachine(md);
            obj = obj@MachineSGECluster(md, qd,...
                                   parEnvStr, resourceStr,...
                                   hostID, hostOS, baseDir, scratchDir, ...
                                   simFileSourceDir, custFileSourceDir,...
                                   modelFileSourceDir,...
        ...
        % This is called from Sim_Neuron.
