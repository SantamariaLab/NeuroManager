...
% MachineMySGEClus01ALL
classdef MachineMySGEClus01ALL < MachineMySGECluster01
    methods
        function obj = MachineMySGEClus01ALL(~,...
        ...
        qd = mySGECluster01QueueData.ALL;
        parEnvStr = '';     % 'mt 8';     
        resourceStr = '';   % mySGECluster01 specific for all.q
