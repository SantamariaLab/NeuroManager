...
% MachineMyServer02
% MyServer02 has no constraints on wallclocktime.
classdef MachineMyServer02 < MachineGenericUNIX & NeuronMachine
    methods
        function obj = MachineMyServer02(~,...
                            hostID, hostOS, baseDir, scratchDir, ...
                            simFileSourceDir, custFileSourceDir,... 
                            modelFileSourceDir,... 
                            simType, numSims,...
                            auth, log, notificationSet)
            md = createMyServer02Data();
            obj = obj@NeuronMachine(md);
            obj = obj@MachineGenericUNIX(md, hostID, hostOS, baseDir,...
                                    scratchDir, ...
                                    simFileSourceDir, custFileSourceDir,... 
                                    modelFileSourceDir,... 
                                    simType, numSims,...
        ...
        % Since myServer02 has no distinction between P and D stages
        ...
        % Neuron model processing is machine-dependent
        % Refer to NeuroManagerStaging.xlsx
        % Since the myServer02 has no distinction between P and D stages
        % we pick the D stage arbitrarily to do mod file compilation
