...
% MachineMyServer01
% myServer01 has no constraints on wallclocktime.
classdef MachineMyServer01 < MachineGenericUNIX & NeuronMachine
    methods
        function obj = MachineMyServer01(~,...
                            hostID, hostOS, baseDir, scratchDir, ...
                            simFileSourceDir, custFileSourceDir,... 
                            modelFileSourceDir,... 
                            simType, numSims,...
                            auth, log, notificationSet)
            md = createMyServer01Data();
        ...
        % Since myServer01 has no distinction between P and D stages
