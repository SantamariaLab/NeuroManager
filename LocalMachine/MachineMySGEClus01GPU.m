...
% MachineMySGEClus01GPU
classdef MachineMySGEClus01GPU < MachineMySGECluster01
    methods
        function obj = MachineMySGEClus01GPU(~,...
        ...
        qd = mySGECluster01QueueData.GPU;
        parEnvStr = 'mt 8';          
        resourceStr = 'gpu';     % mySGEClus01 specific for bigmem.q
