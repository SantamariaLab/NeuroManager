...
% XCompileMyServer02
% A class which supports MATLAB cross-compilation on myServer02.
classdef XCompileMyServer02 < XCompileMachine
    methods
        function obj = XCompileMyServer02(hostID, hostOS, idExt, auth)
