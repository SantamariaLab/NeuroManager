...
% MySGECluster01QueueData.m
% A class which identifies the queues on the user's SGE Cluster
classdef MySGECluster01QueueData
    properties
        extension;
        jobString;
    end
    methods
        function qd = MySGECluster01QueueData(extension, jobString)
