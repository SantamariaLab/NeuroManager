...
nm.constructMachineSet(SimType.SIM_NEURON_SIMPLESPIKE02A, config);

fromFile = false;
if fromFile
    result = nm.runFromFile('SimpleSpike02ASimSpec.txt'); %#ok<UNRCH>
else
    sspec = SimSpec();
    sspec.addTokenSet('SIMSETDEF', 'SimpleSpike02A', {'SIM_NEURON_SIMPLESPIKE02A'});
    sspec.addTokenSet('SIMDEF', 'SingleRun1',  { '1', '.0003', '1000'});                   
    sspec.addTokenSet('SIMDEF', 'SingleRun2',  { '2', '.0003', '1000'});                   
    sspec.addTokenSet('SIMDEF', 'SingleRun3',  { '3', '.0003', '1000'});                   
    sspec.addTokenSet('SIMDEF', 'SingleRun4',  { '4', '.0003', '1000'});                   
    sspec.addTokenSet('SIMDEF', 'SingleRun5',  { '5', '.0003', '1000'});                   
