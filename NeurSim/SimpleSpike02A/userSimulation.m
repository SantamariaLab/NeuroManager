...
function [result, errMsg] =...
    ...
    % since the parameters.hoc was developed on the host. However we do use
    % them for the plot title (below).
    currentStr = varargin{1};
    durationStr = varargin{2};
    
    dataFilePath = fullfile(runDir, [simID '.dat']);
