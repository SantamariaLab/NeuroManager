...
addpath('..') % To catch the superclass which is not in custom dir
...
config.addMachine(MachineType.MYSGECLUS01ALL,  0, 'WorkDirOnMYSGECLUS01ALL');
config.addMachine(MachineType.MYSGECLUS01BM,   0, 'WorkDir');
config.addMachine(MachineType.MYSGECLUS01GPU,  0, 'WorkDir');
config.addMachine(MachineType.MYSGECLUS01IB,   2, 'WorkDir');
config.addMachine(MachineType.STAMPEDEDEV,     1, 'WorkDir',...
                                                  'wallClockTime', '00:15:00');
config.addMachine(MachineType.STAMPEDENORMAL,  2, 'WorkDir',...
                                                  'wallClockTime', '00:15:00');
nm.testCommunications(config);
nm.constructMachineSet(SimType.SIM_NEUR_PURKINJE_MIYASHO2001_KH, config);
...
if fromFile
    ...
    sspec = SimSpec();
    sspec.addTokenSet('SIMSETDEF', 'KhStudy', {'SIM_NEUR_PURKINJE_MIYASHO2001_KH'});
    %                 cmd       id
    ...
    sspec.addTokenSet('SIMDEF', 'Spike+1800A',...
        {'1.80', '-65.0', '20.0', '400.0', '0.025', '1000.0', '0.1',...
         '0.0005',   '0.0000',     '0.0000'}); % Should be identical to original seen in file
    sspec.addTokenSet('SIMDEF', 'Spike+1800B',...
        {'1.80',  '-65.0', '20.0', '400.0', '0.025', '1000.0', '0.1',...
         '0.0005',   '0.0003',    '0.0000'});                  
    sspec.addTokenSet('SIMDEF', 'Spike+1800C',...
        {'1.80',  '-65.0', '20.0', '400.0', '0.025', '1000.0', '0.1',...
         '0.0005',   '0.0000',     '0.0003'});                  
    sspec.addTokenSet('SIMDEF', 'Spike+1800D',...
        {'1.80',  '-65.0', '20.0', '400.0', '0.025', '1000.0', '0.1',...
         '0.0005',   '0.0003',     '0.0003'});                  
    sspec.addTokenSet('SIMDEF', 'Spike+1800E',...
        {'1.80',  '-65.0', '20.0', '400.0', '0.025', '1000.0', '0.1',...
         '0.0005',   '0.0005',     '0.0005'});                  
    sspec.addTokenSet('SIMDEF', 'Spike+1800F',...
        {'1.80', '-65.0', '20.0', '400.0', '0.025', '1000.0', '0.1',...
         '0.0005',   '0.0000',     '0.0000'}); % Should be identical to original
   sspec.addTokenSet('SIMDEF', 'Spike+1800G',...
        {'1.80',  '-65.0', '20.0', '400.0', '0.025', '1000.0', '0.1',...
         '0.0005',   '0.0003',    '0.0000'});                  
    sspec.addTokenSet('SIMDEF', 'Spike+1800H',...
        {'1.80',  '-65.0', '20.0', '400.0', '0.025', '1000.0', '0.1',...
         '0.0005',   '0.0000',     '0.0003'});                  
    sspec.addTokenSet('SIMDEF', 'Spike+1800I',...
        {'1.80',  '-65.0', '20.0', '400.0', '0.025', '1000.0', '0.1',...
         '0.0005',   '0.0003',     '0.0003'});                  
