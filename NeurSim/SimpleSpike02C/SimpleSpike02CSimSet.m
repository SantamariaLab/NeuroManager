...
% has been modified to rely on the default value of Leak gl, and Leak.mod
% is not available but instead is created on the fly.
...
nm.constructMachineSet(SimType.SIM_NEURON_SIMPLESPIKE02C, config);

sspec = SimSpec();
sspec.addTokenSet('SIMSETDEF', 'SimpleSpike02C', {'SIM_NEURON_SIMPLESPIKE02C'});
sspec.addTokenSet('SIMDEF', 'Simulation01',  { '2', '3e-5', '1000'});                   
sspec.addTokenSet('SIMDEF', 'Simulation02',  { '3', '3e-5', '1000'});                   
sspec.addTokenSet('SIMDEF', 'Simulation03',  { '2', '3e-4', '1000'});                   
sspec.addTokenSet('SIMDEF', 'Simulation04',  { '3', '3e-4', '1000'});                   
sspec.addTokenSet('SIMDEF', 'Simulation05',  { '2', '0.0003', '1000'});                   
sspec.addTokenSet('SIMDEF', 'Simulation06',  { '3', '0.0003', '1000'});                   
sspec.addTokenSet('SIMDEF', 'Simulation07',  { '2', '5e-4', '1000'});                   
sspec.addTokenSet('SIMDEF', 'Simulation08',  { '3', '5e-4', '1000'});                   
sspec.addTokenSet('SIMDEF', 'Simulation09',  { '2', '9e-4', '1000'});                   
sspec.addTokenSet('SIMDEF', 'Simulation10',  { '3', '9e-4', '1000'});                   
