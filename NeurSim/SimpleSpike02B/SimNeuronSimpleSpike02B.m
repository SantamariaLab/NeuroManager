...
% SimNeuronSimpleSpike02B
% A hoc-only Neuron simulator that changes two input parameters by
% constructing parameters.hoc on-the-fly in the target-side
% UserSimulation.m file. 
classdef SimNeuronSimpleSpike02B < SimNeuron
    properties
        version;
    end
    ...
    methods
        function obj = SimNeuronSimpleSpike02B(id, machine, type, dbH, ...
                                               log, notificationSet)
        ...
        % Abstract is in Sim_Neuron.
            ...
            % Since there is no mention in the HocFileList of
            % parameters.hoc, it's up to UserSimulation to move it around
