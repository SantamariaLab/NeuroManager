...
% nmRun.m
% A private method that is part of the NeuroManager class definition.
% This is NOT the Run Stage seen in the workflow; that is found in
% Simulator.m.
% -------------------
function result = nmRun(obj, simset)
    ...
    if obj.simNotificationSet.isEnabled()
        ...
        obj.simNotificationSet.send(notificationSubject,...
         ['SimSet ' obj.nmSimSet.getID() ' simulations started.'], '');
    end
    ...
    % For now; need a better comprehensive sense of what a
    % successful run is 
%     result = 0; 
end
