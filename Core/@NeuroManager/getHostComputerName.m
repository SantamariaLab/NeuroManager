...
% getHostComputerName
% Modified from http://www.mathworks.com/matlabcentral/fileexchange/
%      16450-get-computer-name-hostname/content/getComputerName.m
%
function name = getHostComputerName(obj) %#ok<INUSD>
