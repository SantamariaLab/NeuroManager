...
% CommandType
% A class which defines the types a machine command can be.
% Syntax Reference:
%   http://www.mathworks.com/help/matlab/matlab_oop/properties-with-constant-values.html
classdef CommandType
   properties (Constant)
      UNKNOWN       = 0;
      FILESYSTEM    = 1;    % Command deals directly with the filesystem
      JOBSUBMISSION = 2;    % Command submits a job
   end
end