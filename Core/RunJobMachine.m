...
classdef RunJobMachine < MATLABCompileMachine
    ...
    methods (Abstract)
        preRunCreateJobFile(obj) % See NeuroManagerStaging.xlsx
        postRunJobProc(obj)      % See NeuroManagerStaging.xlsx
    ...
    methods
        function obj = RunJobMachine(md, ...
                                     xcmpMach, xcmpDir,...
                                     hostID, hostOS, idExt, auth)
            obj = obj@MATLABCompileMachine(md, ...
                                           xcmpMach, xcmpDir,...
                                           hostID, hostOS, idExt, auth);
        end
    end
