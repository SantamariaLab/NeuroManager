...
classdef SLURMCluster < SimMachine & Cluster
    ...
    methods
        function obj = SLURMCluster(hostID, hostOS, scratchDir,...
                                    simFileSourceDir, custFileSourceDir,...
                                    modelFileSourceDir,...
                                    simType,...
                                    auth, dbH, log, notificationSet, config)
            obj = obj@Cluster(config, hostID, hostOS, auth);
            obj = obj@SimMachine(config, hostID, scratchDir, ...
                                 simFileSourceDir, custFileSourceDir,...
                                 modelFileSourceDir,...
                                 simType, auth, dbH, log, notificationSet);
            obj.wallClockTime = config.wallClockTime;
            obj.numNodes = config.numNodes;
