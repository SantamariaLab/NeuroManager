...
% SimNoModelMLOnly
% The simulator class that defines the simulations with no model files and
% using only MATLAB.
classdef SimNoModelMLOnly < NoModelFileSim
    methods
        function obj = SimNoModelMLOnly(simulatorID,...
                                machine, dbH, ...
                                log, notificationSet)
            obj = obj@NoModelFileSim(simulatorID,...
                                     machine, dbH, ...
                                     log, notificationSet);
        end

        % -------------
        function preUploadFiles(obj)  %#ok<MANU>
        ...
        function removeRemoteAspect(obj)
            ...
            removeRemoteAspect@NoModelFileSim(obj);
        end
    end 
end
