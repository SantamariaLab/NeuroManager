...
% MachineSLURMCluster
% The concrete superclass for a cluster using SLURM, such as the Stampede cluster
% at TACC. This is a core file; try not to modify it; rather modify
% Machine_Stampede, which embodies the specific SLURM cluster
% idiosyncracies.
classdef MachineSLURMCluster < SimMachine & SLURMMachine
    properties
        numNodes; 
        queueStr;
        wallClockTime;
    ...
    methods
        function obj = MachineSLURMCluster(ms, qd,...
            ...
            obj = obj@SLURMMachine(ms, xCompilationMachine,...
                             xCompilationScratchDir,...
                             hostID, hostOS, qd.extension, auth);
            obj = obj@SimMachine(ms, qd.extension,...
