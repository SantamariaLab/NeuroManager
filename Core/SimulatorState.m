...
% SimulatorState
% A class which defines the states in which a Simulator can be.
classdef SimulatorState
    properties (Constant)
        % For constructor
        UNASSIGNED      = 0;
        
        % Simulator is under construction on the remote
        INPREPARATION   = 1;
        
        % Simulator is ready to run a simulation but doesn't have one yet
        AVAILABLE       = 2;
