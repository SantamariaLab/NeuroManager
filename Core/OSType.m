...
% OSType.m
% A class which defines the types that a OS can be. This class handles
% type for target machines as well as the host machine; however, the
% software assumes that all target machines are UNIX.
%
classdef OSType
   properties (Constant)
        UNDEFINED   = 0;
