...
% Note: This is a slightly modified version of the ssh2_main.m file found
% in the m1 version of the SSH2 library, and is located in the NeuroManager
% Core directory so that it will override the library-installed version.
...
if (ssh2_struct.autoreconnect == 1 && ssh2_struct.authenticated == 1) % assume we're already connected
    try
        ...
        fprintf('SSH2 Connection lost. Reconnecting...\n');
