...
% Machine_SGECluster
% The concrete class for Sun Grid Engine clusters. Job submission is done
% by qsub. 
classdef MachineSGECluster < SimMachine & QSUBMachine
    properties 
        parEnvStr;
        queueStr;
        resourceStr;
    ...
    methods
        function obj = MachineSGECluster(md, qd, ...
            ...
            obj = obj@QSUBMachine(md, xCompilationMachine,...
                             xCompilationScratchDir,...
